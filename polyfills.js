"use strict";
(self["webpackChunkngx_barcode_scanner_demo"] = self["webpackChunkngx_barcode_scanner_demo"] || []).push([["polyfills"],{
...
function createDirectiveDefinitionMap(meta) {
  ...
  definitionMap.set('version', literal('14.2.7')); // e.g. `type: MyDirective`
